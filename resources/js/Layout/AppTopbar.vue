        ...
        <div class="layout-topbar-actions items-center">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <div class="flex items-center gap-2 relative layout-topbar-action-user">
                            <Button
                                text
                                class="p-0 flex items-center gap-2"
                                @click="toggleUserMenu"
                            >
                                <div
                                    class="bg-blue-100 dark:bg-blue-400/10 font-bold flex items-center justify-center rounded-full text-xl"
                                ...
                                <i class="pi pi-chevron-down text-gray-500 text-xs ml-1"></i>
                            </Button>
                            <Menu
                            ref="userMenu"
                            :model="userMenuItems"
