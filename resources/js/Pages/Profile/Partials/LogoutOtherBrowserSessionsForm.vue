...
watch(() => form.recentlySuccessful, (newVal) => {
    if (newVal) {
        toast.add({ severity: 'success', summary: 'Success', detail: 'Done.', life: 3000 });
    }
});
</script>
            ...
            <div v-if="sessions.length > 0" class="mt-5 space-y-6">
                <div v-for="(session, i) in sessions" :key="i" class="flex items-center">
                    <div>
                        ...
                        <svg v-else class="size-8 text-gray-500 dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div class="ms-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500 dark:text-white">
                                ...
                                <span v-if="session.is_current_device" class="text-green-500 font-semibold dark:text-white">This device</span>
